                        ...
                        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
                            {stats.map((stat, index) => (
                                <motion.div
                                    ...
                                    className="text-center ring-2 ring-primary dark:ring-primary/40 rounded-xl p-6 shadow-lg bg-white dark:bg-dark-card"
                                >
                    ...
                    <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {values.map((value, index) => (
                            <motion.div
                                ...
                                className="rounded-xl bg-white p-6 shadow-lg transition-shadow hover:shadow-xl dark:bg-dark-card ring-2 ring-primary dark:ring-primary/40"
                            >
