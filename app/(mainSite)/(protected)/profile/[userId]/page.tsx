...
const ProfilePage = async ({
    ...
    const [existingLoggedInUser, userPaymentHistory, userPurchasedExams, userQuizSessions] = await Promise.all([getUserByIdUnstableCache(userId), getUserPaymentHistoryUnstableCache(userId), getUserPurchasedExamHistoryUnstableCache(userId), getUserQuizSessionsUnstableCache(userId)]);
            ...
            <div className="mx-auto max-w-7xl space-y-8">
                <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div className="space-y-8 md:col-span-2 lg:col-span-3">
                        ...
                        >
                            <PurchasedExamHistorySection purchasedExams={userPurchasedExams} />
                        </Suspense>
                        ...
                        <Suspense
                            fallback={<Skeleton className="h-[300px] w-full rounded-xl" />}
                        >
                            <ExamHistorySection userQuizSessions={userQuizSessions} userId={userId} />
                        </Suspense>
...
async function ExamHistorySection({ userQuizSessions, userId }: { userQuizSessions: UserQuizSession[], userId: string }) {
            ...
            <div className="p-6">
                <div className="mb-4 flex items-center justify-between">
                    ...
                    <Button variant="link" asChild>
                        <Link href={`/profile/${userId}/exam-history`}>
                            View All
                        </Link>
                    </Button>
                </div>
