...
async function PaymentHistorySection({
    ...
    if (!paymentHistory || paymentHistory.length === 0) {
        return (
            <div className="rounded-xl bg-white p-6 text-center shadow-lg transition-shadow hover:shadow-xl dark:bg-dark-card">
                        ...
                        >
                            <div className="mb-3 flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <span
                                        className={`text-sm font-medium ${payment.status === "SUCCEEDED"
                                            ? "text-green-500"
                                            : "text-red-500"
                                            }`}
                                    >
