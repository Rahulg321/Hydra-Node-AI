...
const CookiePolicyPage = () => {
  return (
    <section className="block-space narrow-container">
      <h2>Cookie Policy</h2>
      <p>Effective Date: May 10, 2024</p>
      <p>
        We use cookies to help improve your experience of our website at&nbsp;
        <u>
          <a href="https://hydranode.ai">https://hydranode.ai</a>
        </u>
        . This cookie policy is part of HydraNode&apos;s privacy policy. It
      ...
      <p>
        If you don&rsquo;t wish to accept cookies from us, you should instruct
      ...
      <p>
        ...
        browser when you return, additional data that serves the cookie&rsquo;s
      ...
      <p>
        ...
        improving their audience&rsquo;s overall website experience. These
        cookies may be set by the website you&rsquo;re visiting (first-party) or
        by third-party services. They do not collect personal information about
        you.
      </p>
      ...
      <p>
        ...
        and any settings you may configure on the website you&rsquo;re visiting
        ...
        services. These cookies may be set by the website you&rsquo;re visiting
      ...
      <p>
        ...
        website. Please note that Essential cookies cannot be rejected as they
        are strictly necessary to provide you with the services on our website.
      </p>
      <p>
        You may be able to set or amend your cookie preferences by managing your
        web browser settings. As each web browser is different, please consult
        the instructions provided by your web browser (typically in the
      ...
      <p>
        Customer Service
        <br />
        <a href="mailto:contact@hydranode.ai">contact@hydranode.ai</a>
      </p>
    </section>
  );
};
