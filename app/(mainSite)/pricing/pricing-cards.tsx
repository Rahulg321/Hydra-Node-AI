  ...
  const plans = [
    {
      ...
      popular: true,
      features: [
        "Access to all the IT certifications prearation mock exam",
          ...
          <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-2">
            {plans.map((plan, index) => (
              <motion.div
                ...
                className="relative overflow-hidden rounded-lg border border-[rgba(255,255,255,0.1)] bg-[linear-gradient(0deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2)),linear-gradient(112.86deg,rgba(255,255,255,0.08)_-6.68%,rgba(255,255,255,0.024)_45.63%,rgba(255,255,255,0.08)_103.45%)]"
              >
                <div className="">
                  {
                    <div className="absolute left-[-1/2] top-3/4 h-[10rem] w-64 -translate-x-1/2 rounded-full bg-orange-500 opacity-40 blur-3xl" />
                  }
                  {index === 0 && billingPeriod === "yearly" && (
