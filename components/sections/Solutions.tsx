...
const FeatureSection = ({ title, features, index }: any) => {
    ...
    return (
        <motion.div
            ...
            className="perspective transform rounded-2xl border-gray-200 bg-white/80 p-6 backdrop-blur-sm dark:border-gray-800 dark:bg-dark-card/40 ring-2 ring-primary dark:ring-primary/40"
        >
